...
{/*           <span
          ...
          <span className="text-xs text-gray-100 tracking-wide">Your Strategic Partner in Next-Gen Tech Innovation</span>
          {/* Right punch hole */}
          <span className="inline-block w-3 h-3 rounded-full relative"
            style={{
              background: 'radial-gradient(circle at 30% 30%, #4b5563, #1f2937)',
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-300 via-blue-100 to-white bg-clip-text text-transparent">
            We Empower Modern Enterprises with {" "}
        ...
        >
          SaaS Solutions | AI-Powered Agents | Intelligent Dashboards & Data InterfacesNext-Gen Data Visualization | Full-Stack Web & Mobile Applications        </motion.p>
        {/* CTA Button */}
        <motion.button
      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-8 items-center">
            {["UFTA", "CodeProjekt", "Green Heaven Adventures", "Ocean Visuals"].map((company, index) => (
              <motion.span
                key={company}
